        ...
        <section className="section projects-main" id="projects" >
            ...
            <div className="projects-main-row" >
                <article className="projects-article">
                    ...
                    <p class="projects-tech"><strong>Tech used: <span class="html">HTML</span>, <span class="scss">SCSS</span>, <span class="javascript">JavaScript</span></strong></p>
                </article>
            ...
            <div class="projects-main-row">
                <article className="projects-article project-study">
                    <h3 class="projects-article-header"><a href="https://timbu.com/study">Timbu Admissions</a></h3>
                    ...
                    <p class="projects-tech"><strong>Tech used: <span class="html">HTML</span>, <span class="scss">SCSS</span>, <span class="javascript">JavaScript</span>, <span class="laravel">Laravel</span></strong></p>
                </article>
                <div class=" projects-image projects-image3">
                    <div class="box-animation ">
                        <img class="header-img" alt="" src={Timbu} />
                    </div>
                </div>
            </div>
            <div class="row projects-main-row">
                <article className="projects-article project-factory">
                    <h3 class="projects-article-header">Factory</h3>
                    ...
                    <p class="projects-tech"><strong>Tech used: <span class="html">HTML</span>, <span class="scss">SCSS</span>, <span class="javascript">JavaScript</span>, <span class="bootstrap">Bootstrap</span></strong></p>
                </article>
                <div class=" projects-image projects-image3">
                    <div class="box-animation ">
                        <img class="header-img" alt="" src={Factory} />
                    </div>
                </div>
            </div>
